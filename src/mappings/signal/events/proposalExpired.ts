...
import { getProposalExpiredData } from './getters'
...
async function handleProposalExpiredEvent(ctx: EventHandlerContext, block: SubstrateBlock, event: Event) {
	let proposalIdArray = getProposalExpiredData(ctx, event)
