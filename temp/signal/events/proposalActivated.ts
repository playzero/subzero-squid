...
async function handleProposalActivatedEvent(ctx: EventHandlerContext, block: SubstrateBlock, event: Event) {
	let proposalIdArray = getProposalActivatedData(ctx, event)
